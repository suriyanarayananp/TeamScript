...
my $hashref = $database->GetAllUrls("376cd597b7369ea23bc06bc16273e1b486cf83dc");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Matalan_UK::Matalan_UK_DetailProcess($product_object_key,$product_url,'Matalan-UK--worker',"376cd597b7369ea23bc06bc16273e1b486cf83dc",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3128',$ua,$database,$images,$utility);
}
