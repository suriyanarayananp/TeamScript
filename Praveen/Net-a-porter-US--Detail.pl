...
my $hashref = $database->GetAllUrls("123011a3ef9a5846c7b62bde1701a8f6");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Netaporter_US::Netaporter_US_DetailProcess($product_object_key,$product_url,'Net-a-porter-US--worker',"123011a3ef9a5846c7b62bde1701a8f6",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3129',$ua,$database,$images,$utility);
}
