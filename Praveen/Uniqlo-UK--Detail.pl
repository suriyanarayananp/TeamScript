...
my $hashref = $database->GetAllUrls("51df8b58c04dfd5db9988153bf50308f26ad32c1");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Uniqlo_UK::Uniqlo_UK_DetailProcess($product_object_key,$product_url,'Uniqlo-UK--worker',"51df8b58c04dfd5db9988153bf50308f26ad32c1",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3128',$ua,$database,$images,$utility);
}
