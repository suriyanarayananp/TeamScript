...
my $hashref = $database->GetAllUrls("6899ecaf71fe7aa575df8bf77782a24d3287fc");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Asos_US::Asos_US_DetailProcess($product_object_key,$product_url,'Asos-US--worker',"6899ecaf71fe7aa575df8bf77782a24d3287fc",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3129',$ua,$database,$images,$utility);
}
