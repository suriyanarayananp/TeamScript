...
my $Retailer_Random_String='Jigsaw';
my $pid = $$;
...
my $hashref = $database->GetAllUrls("8b48e2ff20af1732909e2a4ed5af7f02b919ed7");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Jigsaw_UK::Jigsaw_UK_DetailProcess($product_object_key,$product_url,'Jigsaw-UK--worker',"8b48e2ff20af1732909e2a4ed5af7f02b919ed7",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3128',$ua,$database,$images,$utility);
}
