...
my $hashref = $database->GetAllUrls("9d1c914f2617f1f9aa65ef703a1a7668ba6679a6");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Netaporter_UK::Netaporter_UK_DetailProcess($product_object_key,$product_url,'Net-a-porter-UK--worker',"9d1c914f2617f1f9aa65ef703a1a7668ba6679a6",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3128',$ua,$database,$images,$utility);
}
