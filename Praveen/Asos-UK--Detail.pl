...
my $hashref = $database->GetAllUrls("16f0a3234bafc0d64d1ac7e7bddc7e8c6397156c");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Asos_UK::Asos_UK_DetailProcess($product_object_key,$product_url,'Asos-UK--worker',"16f0a3234bafc0d64d1ac7e7bddc7e8c6397156c",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3128',$ua,$database,$images,$utility);
}
