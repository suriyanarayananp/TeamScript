...
# my $db_name = "meritdevdb";
# my $dbh = DBI->connect("DBI:mysql:database=$db_name;host=collection-db-prod-merit.cloud.trendinglines.co.uk;port=3306","myadmin","dfFDG567HGf45")  or die "Cannot connect to MySQL server\n";
###########################################
...
foreach (keys %hashUrl)
{
	...
	&Stagestores_US::Stagestores_US_DetailProcess($product_object_key,$product_url,$dbh,$robotname,$retailer_id);
}
