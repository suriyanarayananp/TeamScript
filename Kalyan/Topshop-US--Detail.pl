...
my $hashref = $database->GetAllUrls("704effbbac1d79993c9e8b5bf5283378");
my %hashUrl = %$hashref;
foreach (keys %hashUrl)
{
	...
	&Topshop_US::Topshop_US_DetailProcess($product_object_key,$product_url,'Topshop-US--worker',"704effbbac1d79993c9e8b5bf5283378",$logger,'http://frawspcpx.cloud.trendinglines.co.uk:3129',$ua,$database,$images,$utility);
}
